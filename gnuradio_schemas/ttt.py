...
class ttt(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "ttt")
        ...
        self.qtgui_waterfall_sink_x_0_0_0.set_intensity_range(0, 10)
        ...
        self.blocks_wavfile_source_0_0 = blocks.wavfile_source('/Users/tempdelta/Desktop/jammer_exp/Bach_C_minor_Passacaglia_Variation_2.wav', False)


        ##################################################
        # Connections
        ##################################################
        self.connect((self.blocks_wavfile_source_0_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.blocks_wavfile_source_0_0, 0), (self.qtgui_waterfall_sink_x_0_0_0, 0))
...
def main(top_block_cls=ttt, options=None):
