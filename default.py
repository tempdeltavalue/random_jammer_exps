...
class default(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/Users/tempdelta/Desktop/jammer_exp/Bach_C_minor_Passacaglia_Variation_2.wav', False)
        ...
        self.blocks_float_to_uchar_0 = blocks.float_to_uchar(1, 127.5, 127.5)
        ...
        self.connect((self.blocks_throttle2_0, 0), (self.blocks_float_to_uchar_0, 0))
        self.connect((self.blocks_throttle2_0, 0), (self.qtgui_waterfall_sink_x_0_0, 0))
        self.connect((self.blocks_uchar_to_float_0, 0), (self.qtgui_waterfall_sink_x_0, 0))
        self.connect((self.blocks_uchar_to_float_1, 0), (self.qtgui_waterfall_sink_x_1, 0))
