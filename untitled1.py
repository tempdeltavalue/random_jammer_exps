...
class untitled1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "untitled1")
        ...
        # Variables
        ##################################################
        self.samp_rate_0 = samp_rate_0 = 44000
        ...
        # Connections
        ##################################################
        self.connect((self.blocks_add_const_vxx_0, 0), (self.qtgui_waterfall_sink_x_0, 0))
        self.connect((self.blocks_float_to_uchar_0, 0), (self.blocks_repack_bits_bb_0, 0))
